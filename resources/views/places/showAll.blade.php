...
<div class="container">
    <div class="section">
        <h5 class="center grey-text text-darken-1">Lugares</h5>
    </div>
    <div class="divider"></div>
    <div class="section">
        <table id="placesTable" cellspacing="0" width="100%" class="myTable">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>NOMBRE</th>
...
<script type="text/javascript">
    ...
    $('#placesTable').on('click', 'tbody tr', function() {
